...
SurakṣāMārga.ai is an intelligent navigation system that recommends the **safest walking routes** by analyzing real crime data, time-of-day risk patterns, and crowd density. It leverages 5G capabilities for ultra-low latency real-time safety monitoring and instant SOS emergency response.
...
createdb surakshamarga
psql surakshamarga -c "CREATE EXTENSION postgis;"
```
...
Built for hackathon submission - SurakṣāMārga.ai
